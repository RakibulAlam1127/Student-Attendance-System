...
<body>
     <div class="container">
         <div class="well">
             <h1 style="text-align: center">Students Attendance System</h1>
         </div>
            <?php
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                   <div class="panel-heading">
                        <div class="center">
                           ...
                           <a href="addstudent.php" class="pull-left btn btn-info">Add Student</a>
                           <a href="upgrade.php" class="pull-right btn btn-primary">Upgrade</a>
                   </div>
